			...
			<main>
				...
				<p className="description">
					...
					<a
						target="_blank"
						rel="noopener"
						href="https://lenka-silna.sentry.io/issues/?project=4511432959787008"
					>
						Issues Page
					</a>
				...
				{hasSentError ? (
					...
					<div className="connectivity-error">
						<p>
							...
							blocked, which will prevent errors from being
							captured. Try disabling your ad-blocker to complete
							the test.
						</p>
					</div>
				) : (
